...
* Oliver Adams: _Bitext alignment for unwritten languages_
* Mat Bettinson: _Effect of respeaking on phonetic transcription accuracy_
* Richard Cox: _Algorithm production and educational implications_
* Lauren Gawne: _Usability of mobile software in indigenous communities_
* Sumukh Ghodke: _Scalable query for time-series annotations_
* Florian Hanke: _Mobile software for language preservation_
* Benjamin King: _Practical Natural Language Processing for Minority Languages_ (University of Michigan)
* Haejoong Lee: _Open language archives, prosodic systems_ (University of Pennsylvania)
* Duong Thanh Long: _Universal part-of-speech tagging_
* Mak Nazecic-Andrlon: _Software for teaching graph algorithms_
* Quynh-Chi Nguyen: _Computational modelling of speech prosody_

h3. Leadership

* Associate Editor for ACM Transactions on Asian and Low-Resource Language Information Processing
...
* Member of Program Committee for the 14th International Conference on Computational Linguistics (COLING), Dublin, Ireland (August 2014)
...
* "Current Trends in Language Documentation":http://workshopdoccampinas2013.com.br/?lang=en Campinas, Brazil (2013)
